...
%^--- csc made a strageic decision to move away from this business model, ie this is the old version. 
% climatedg1 1.0 qualitative reports for commodities traders closed down and why (anne marie)
%    annie marie can provide logic on why that is
% 2.0 is a pivot and we're working on quantitative prediction for general insurance
% the pivot supports that qualitative portion of my hypothesis doesn't work
% we asume this info is adequate to determine there is a need on the part of the client, so we're going to focus on how we would do this
% what will people buy and what's it take to deliver it <--- this is really important
...
%these bullets dont' specify that they are qualitative
...
%CSC has already decided to move into new market segments, this opens up tornado analytics
